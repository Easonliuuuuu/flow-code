...
import { PLACEHOLDER_TEST_COMMAND, TEST_COMMANDS_AUTO } from '../registry/index.js';
...
function discoverWithAgent(ctx) {
 ...
 */
async function resolvePlaceholder(ctx) {
    ...
    ctx.node.config = { ...ctx.node.config, commands: chosen };
    return chosen;
}
/**
