...
function detectFromPackageJson(repoRoot: string): string[] {
...
function detectFromMakefile(repoRoot: string): string[] {
...
function detectPytest(repoRoot: string): string[] {
...
function detectGoTest(repoRoot: string): string[] {
  return existsSync(join(repoRoot, 'go.mod')) ? ['go test ./...'] : [];
}

function detectCargoTest(repoRoot: string): string[] {
 ...
 */
export function detectTestCommands(repoRoot: string): string[] {
  return [
