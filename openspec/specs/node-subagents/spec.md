...
Delegation inside a node: when a node's agent session may spawn subagents, what bounds them, how their work is attributed, and how the run's concurrency cap accounts for them.
